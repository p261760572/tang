...
{
    23,
    "ti_bc_ivr_mobile_inf.pc"
};


static unsigned int sqlctx = 679991819;
...
{12,4274,850,0,0,
5,0,0,1,189,0,4,60,0,0,3,1,0,1,0,2,97,0,0,2,97,0,0,1,97,0,0,
32,0,0,2,0,0,29,87,0,0,0,0,0,1,0,
};
...

{
        ...
        sqlstm.stmt = "select mobileno ,preno into :s1 ,:s2   from (select \
mobileno ,preno  from ti_bc_ivr_mobile_inf where :b1 like (rtrim(mobileno)||'\
%') order by length(rtrim(mobileno)) desc  ) where rownum<=1";
        ...
        sqlstm.sqhstv[0] = (         void  *)tiBcIvrMobileInf.mobileno;
        ...
        sqlstm.sqhstv[1] = (         void  *)tiBcIvrMobileInf.preno;
