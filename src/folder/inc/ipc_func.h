...
extern void *_shm_create(const  char *name, size_t size, int *shmid);
extern void *_shm_connect(const char *name, int *shmid);
...
extern int _queue_create(const char *name);
